...
namespace Graph_lib {
    ...
    struct Button: public Widget {
        Button(Point xy, int w, int h, const string& s_label, Callback cb)
            : Widget(xy, w, h, s_label, cb)
        {}
    ...
    struct Menu : Widget {
        ...
        Menu(Point xy, int w, int h, Kind kk, const string& s_label);
       //     : Widget(xy,w,h,s_label,0), k(kk), offset(0)
       // {}
