...
#undef minor
    ...
    struct Color {
        enum Color_type {
            ...
            white = FL_WHITE, black = FL_BLACK, magenta = FL_MAGENTA,
            cyan = FL_CYAN, dark_red = FL_DARK_RED, dark_green = FL_DARK_GREEN,
            dark_yellow = FL_DARK_YELLOW, dark_blue = FL_DARK_BLUE,
    ...
    typedef double Fct2(double, int);
    ...
    struct Bad_image : Fl_Image {
        Bad_image(int hb, int wb) : Fl_Image(hb,wb,0) { }
